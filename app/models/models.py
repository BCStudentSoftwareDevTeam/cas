...
mainDB     = MySQLDatabase ( db_name, host = host, user = username, passwd = password) #, auth_plugin='mysql_native_password'
...
class Term(baseModel):
  ...
  name              = CharField()
  state             = IntegerField(null = False)  # DEPRECATED; DO NOT USE MOVING FORWARD. USE term_state. - SH
...
class Course(baseModel):
  ...
  courseResources   = CharField(default = None)
...
class InstructorCourse(baseModel):
  ...
  course       = ForeignKeyField(Course, related_name='instructors_course', on_delete= 'CASCADE', backref="instructors")
