...
@main_bp.route('/courseTimeline/', defaults={'tid':0}, methods=["GET"])
@main_bp.route('/courseTimeline/<tid>',methods=["GET","POST"])
...
@main_bp.route('/courseTimeline/<tid>/json', methods=["GET","POST"])
