...
def migrate(user, password, db, host):
    tables = [Division,BannerSchedule,ScheduleDays,Term,Building,Rooms,Program,Subject,User,BannerCourses,Course,SpecialTopicCourse,ProgramChair,DivisionChair,InstructorCourse,InstructorSTCourse,Deadline,CourseChange,InstructorCourseChange,CoursesInBanner]
