...
room = Rooms(building = 5, educationTech=1,number ='106', maxCapacity=12, roomType="Lab",  visualAcc="A", audioAcc= "B" ,physicalAcc= "C", educationTech= "A", specializedEq= "Lab equipment", specialFeatures= "Science stuff",movableFurniture=True).save()
