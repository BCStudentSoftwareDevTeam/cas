...
#ROOMS#
######
room = Rooms(building = 1, number ='101', maxCapacity=24, roomType="Lecture",   educationTech = 1, visualAccessibility = "A", audioAccessibility = "B", physicalAccessibility= "A", movableFurniture = True).save()
room = Rooms(building = 2, number ='102', maxCapacity=24, roomType="Lecture",   educationTech = 2, visualAccessibility = "B",  audioAccessibility = "B", physicalAccessibility= "A", movableFurniture = True).save()
room = Rooms(building = 3, number ='103', maxCapacity=24, roomType="Lecture",   educationTech = 3, visualAccessibility = "C", audioAccessibility = "B", physicalAccessibility= "A", movableFurniture = True).save()
room = Rooms(building = 4, number ='104', maxCapacity=24, roomType="Lecture",   educationTech = 3, visualAccessibility = "A", audioAccessibility = "B", physicalAccessibility= "A", movableFurniture = True).save()
room = Rooms(building = 5, number ='105', maxCapacity=24, roomType="Lecture",   educationTech = 3, visualAccessibility = "B", audioAccessibility = "B", physicalAccessibility= "A", movableFurniture = True).save()
room = Rooms(building = 6, number ='106', maxCapacity=24, roomType="Lecture",   educationTech = 3, visualAccessibility = "C", audioAccessibility = "B", physicalAccessibility= "A", movableFurniture = True).save()
room = Rooms(building = 7, number ='107', maxCapacity=24, roomType="Lecture",   educationTech = 3, visualAccessibility = "A", audioAccessibility = "B", physicalAccessibility= "A", movableFurniture = True).save()
room = Rooms(building = 8, number ='108', maxCapacity=24, roomType="Lecture",   educationTech = 3, visualAccessibility = "B", audioAccessibility = "B", physicalAccessibility= "A", movableFurniture = True).save()
room = Rooms(building = 9, number ='109', maxCapacity=24, roomType="Lecture",   educationTech = 3, visualAccessibility = "C", audioAccessibility = "B", physicalAccessibility= "A", movableFurniture = True).save()
room = Rooms(building = 1, number ='201', maxCapacity=24, roomType="Something", educationTech = 1, visualAccessibility = "A", audioAccessibility = "B", physicalAccessibility= "A", movableFurniture = True).save()
room = Rooms(building = 2, number ='202', maxCapacity=24, roomType="Lecture",   educationTech = 1, visualAccessibility = "B",  audioAccessibility = "D", physicalAccessibility= "A", movableFurniture = True).save()
room = Rooms(building = 3, number ='203', maxCapacity=24, roomType="Lecture",   educationTech = 3, visualAccessibility = "C", audioAccessibility = "B", physicalAccessibility= "A", movableFurniture = True).save()
room = Rooms(building = 4, number ='204', maxCapacity=24, roomType="Lecture",   educationTech = 3, visualAccessibility = "A",  audioAccessibility = "B", physicalAccessibility= "A", movableFurniture = True).save()
room = Rooms(building = 5, number ='205', maxCapacity=24, roomType="Lecture",   educationTech = 3, visualAccessibility = "B", audioAccessibility = "B", physicalAccessibility= "A", movableFurniture = True).save()
room = Rooms(building = 6, number ='206', maxCapacity=24, roomType="Something", educationTech = 2, visualAccessibility = "C", audioAccessibility = "A", physicalAccessibility= "A", movableFurniture = True).save()
room = Rooms(building = 7, number ='207', maxCapacity=30, roomType="Lecture",   educationTech = 1, visualAccessibility = "A",  audioAccessibility = "B", physicalAccessibility= "A", movableFurniture = True).save()
room = Rooms(building = 8, number ='208', maxCapacity=18, roomType="Lecture",   educationTech = 3, visualAccessibility = "B", audioAccessibility = "B", physicalAccessibility= "A", movableFurniture = True).save()
room = Rooms(building = 9, number ='209', maxCapacity=18, roomType="Lecture",   educationTech = 3, visualAccessibility = "C", audioAccessibility = "B", physicalAccessibility= "A", movableFurniture = True).save()
room = Rooms(building = 1, number ='301', maxCapacity=18, roomType="Something", educationTech = 1, visualAccessibility = "A", audioAccessibility = "B", physicalAccessibility= "A", movableFurniture = True).save()
room = Rooms(building = 2, number ='302', maxCapacity=15, roomType="Lecture",   educationTech = 1, visualAccessibility = "B",  audioAccessibility = "D", physicalAccessibility= "A", movableFurniture = True).save()
room = Rooms(building = 3, number ='303', maxCapacity=18, roomType="Lecture",   educationTech = 3, visualAccessibility = "C", audioAccessibility = "B", physicalAccessibility= "A", movableFurniture = True).save()
room = Rooms(building = 4, number ='304', maxCapacity=15, roomType="Lecture",   educationTech = 3, visualAccessibility = "A",  audioAccessibility = "B", physicalAccessibility= "A", movableFurniture = True).save()
room = Rooms(building = 5, number ='305', maxCapacity=18, roomType="Lecture",   educationTech = 3, visualAccessibility = "B", audioAccessibility = "B", physicalAccessibility= "A", movableFurniture = True).save()
room = Rooms(building = 6, number ='306', maxCapacity=12, roomType="Something", educationTech = 2, visualAccessibility = "C", audioAccessibility = "D", physicalAccessibility= "A", movableFurniture = True).save()
room = Rooms(building = 7, number ='307', maxCapacity=15, roomType="Lecture",   educationTech = 1, visualAccessibility = "A",  audioAccessibility = "B", physicalAccessibility= "A", movableFurniture = True).save()
room = Rooms(building = 8, number ='308', maxCapacity=18, roomType="Lecture",   educationTech = 3, visualAccessibility = "B", audioAccessibility = "B", physicalAccessibility= "A", movableFurniture = True).save()
room = Rooms(building = 9, number ='309', maxCapacity=18, roomType="Lecture",   educationTech = 3, visualAccessibility = "C", audioAccessibility = "B", physicalAccessibility= "A", movableFurniture = True).save()
...
roompreference= RoomPreferences(course=3, pref_1=4, pref_2=5, pref_3=6, notes="I need a room with windows", any_Choice = "any", none_choice = "no other rooms work", none_Reason = "None").save()
roompreference= RoomPreferences(course=4, pref_1=4, notes="I want these rooms just bc pls", any_Choice = "any").save()
roompreference= RoomPreferences(course=5, pref_1=7, pref_2=8, notes="My room needs good hearing access", any_Choice = "any").save()
...
roompreference= RoomPreferences(course=14, pref_1=4, notes="I prefer a room with good physical access", any_Choice = "any", none_choice = "no other rooms work", none_Reason = "None").save()
